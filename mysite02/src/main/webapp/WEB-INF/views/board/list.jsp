			...
			<div id="board">
				...
				<table class="tbl-ex">
					...
					<tr>
						...
						<a href="<%=request.getContextPath() %>/board?a=view">세 번째 글입니다.</a>
						</td>
						<td>안대혁</td>
						<td>3</td>
					...
					<tr>
						...
						<td style= "text-align:left; padding-left:${1*20}px">
							...
							<a href="<%=request.getContextPath() %>/board?a=view">두 번째 글입니다.</a>
							</td>
						<td>안대혁</td>
						<td>3</td>
						<td>2015-10-02 12:04:12</td>
					...
					<tr>
						...
						<a href="<%=request.getContextPath() %>/board?a=view">첫 번째 글입니다.</a>
						</td>
						<td>안대혁</td>
						<td>3</td>
